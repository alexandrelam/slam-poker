...
function EmojiPickerContent({
  ...
  return (
    <EmojiPickerPrimitive.Viewport
      className={cn(
        "outline-hidden relative flex-1 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-muted [&::-webkit-scrollbar-thumb]:bg-muted-foreground/20 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb:hover]:bg-muted-foreground/30",
        className,
      )}
